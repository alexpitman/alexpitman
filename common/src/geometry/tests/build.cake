# GENERATED
#-------------------------------------------------------------------------------
# Script that can be run to build and run the tests for the geometry library.
#-------------------------------------------------------------------------------
...
objects = compiler.objects(
  targetDir=script.cwd("../../../../build/testbed/obj/geometry/tests"),
  sources=source,
  )
program = compiler.program(
  target=script.cwd("../../../../build/testbed/bin/test_geometry.exe"),
  sources=objects,
  )
